    ...
    return (
        <div>
            ...
            <div className='h-[80vh] flex flex-col items-center justify-center relative w-full'>
                ...
                <h1 className="lg:text-7xl md:text-5xl sm:text-4xl text-3xl font-bold text-white">About Ecomscaled</h1>
                <p className='text-white text-center mt-5'>
                    Our work is to make sure that we exceed your expectations and add value to your brand.
                </p>
            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-start gap-10">
                        ...
                        <div className="flex-1 relative hidden lg:block">
                            <div className="w-full h-64 bg-[#ddd3d1] shadow-xl border-t-4 border-r-4 border-gray-400"></div>
                        </div>
                    </div>

                    {/* Bottom Cards */}
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 bg-[#3e3e3e] text-white p-6 rounded-lg">
                        {/* Card 1 */}
                        <div className="flex flex-col items-center text-center">
                            <div className="w-16 h-16 bg-gray-200 rounded-full mb-4"></div>
                            <h3 className="text-lg font-semibold mb-2">We Commit</h3>
                            <p className="text-sm text-gray-300">
                                Our team of specialists is committed to producing the best results in order to make
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="w-16 h-16 bg-gray-200 rounded-full mb-4"></div>
                            <h3 className="text-lg font-semibold mb-2">We Research</h3>
                            <p className="text-sm text-gray-300">
                                Our experts know how important market research is. No work is done without extensive
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-sm text-gray-300">
                                The quality of our work and your time are both of tremendous importance to us. We
                                deliver the best results promptly!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto space-y-20">
                    ...
                    <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
                        <div className="flex-1 hidden lg:block">
                            <div className="w-full h-64 bg-[#ddd3d1] shadow-xl border-l-4 border-b-4 border-gray-400"></div>
                        </div>
                        <div className="flex-1">
                            <h2 className="text-2xl md:text-3xl font-bold mb-4">Core Values</h2>
                            <ul className="text-gray-800 space-y-3">
                                <li>
                                    <span className="font-semibold">Transparency:</span> No fine print, no empty buzzwords.
                                </li>
                                <li>
                                    <span className="font-semibold">Execution &gt; Excuses:</span> We get things done.
                                </li>
                                <li>
                                    <span className="font-semibold">Clarity:</span> You’ll always know what’s working and why.
                                </li>
                                <li>
                                    <span className="font-semibold">Growth Mindset:</span> We don’t just follow trends — we build with intent.
                                </li>
                                <li>
                                    <span className="font-semibold">People First:</span> Relationships matter more than algorithms.
                                </li>
                            </ul>
                        </div>
                    </div>
